...
def compare_research_depths() -> Dict[str, Dict[str, Any]]:
    ...
    return {
        ...
        "deep": deep_estimate,
        "comparison": {
            "cost_multiplier": round(deep_estimate["estimated_cost_usd"] / standard_estimate["estimated_cost_usd"], 1),
            "time_multiplier": round(deep_estimate["estimated_duration_minutes"] / standard_estimate["estimated_duration_minutes"], 1),
